...
public class Mail {
	...
	public static void send(MailAccounts acc, String recipient, String subject, String text)
		...
		// (für den Fall das beispielsweise die E-Mail verschlüsselt versendet werden
		// soll)
